      ...
      <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 py-24">
          <div className="flex items-center space-x-4 mb-8">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white">Product Development</h1>
          </div>
      ...
      <div className="bg-white py-24">
        <div className="container mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-24">
            ...
            >
              <h2 className="text-3xl font-bold mb-6">Why Choose Our Product Development Services?</h2>
          ...
          {/* Process Section */}
          <div className="mb-24">
            <h2 className="text-3xl font-bold text-center mb-12">Our Product Development Process</h2>
